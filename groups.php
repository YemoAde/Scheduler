<?php
    ...
    if(isset($_POST['report-group-add'])) {
        $report_group_details = array (
            ':report_group_name' => trim($_POST['report_group_name'])
            );
        $report->report_group($report_group_details);
    }
    if (isset($_POST['report-group-delete'])) {
        echo $_POST['delete_select'];
        $report->delete_report_group($_POST['delete_select']);
...
<head>
    ...
    <title>Report System - Manage Report Groups</title>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Manage Report Groups </a>
                    </div>
                                ...
                                <form id="RegisterValidation" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="report_group_name" type="text" required="true" />
                                        </div>
                                        <div class="form-footer text-right">
                                            <button type="submit" name="report-group-add" class="btn btn-rose btn-fill">Add Report Group</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card" style="min-height: 340px">
                                <form id="RegisterValidation" action="" method="POST">
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title">Delete Report Group</h4>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="selectpicker" data-style="btn btn-default" data-size="7" name="delete_select">
                                                ...
                                                ?>
                                                            ...
                                                            <div class="form-footer text-right">
                                                                <button type="submit" name="report-group-delete" class="btn btn-rose btn-fill">Remove Group</button>
                                                            </div>
                                                <?php
                                                    }
                                                ?>
