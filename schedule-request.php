<?php 
    ...
    if (isset($_POST['schedule-request'])) {
        ...
        $schedule->schedule($schedule_details);
    }
                                ...
                                <form id="RegisterValidation" action="" method="POST">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="schedule_title" type="text" required="true" />
                                        </div>
                                        <div class="form-group label-floating">
                                            <label class="control-label">
                                            ...
                                            <select class="selectpicker" data-style="btn btn-default" title="Single Select" data-size="7" name="report_group_id" required>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-lg-8">
                                                <div>
                                                    ...
                                                    <input type="date" class="form-control " value="<?php echo date('m/d/y'); ?>" data-datepicker-color="primary" name="start_date">
                                                </div>
                                            </div>
                                            <div class="col-sm-8 col-lg-8">
                                                <div>
                                                    ...
                                                    <input type="date" class="form-control " value="<?php echo date('m/d/y'); ?>" data-datepicker-color="primary" name="stop_date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="selectpicker" data-style="btn btn-default" title="Single Select" data-size="7" name="frequency">
                                                <option disabled selected>Select sending schedule</option>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" required="true" name="email_addresses" />
                                        </div>
                                        <?php
                                            if(sizeof($list) > 0 ){
                                                ?>
                                                <div class="form-footer text-right">
                                                    <button type="submit" name="schedule-request" class="btn btn-rose btn-fill">Request</button>
                                                </div>
                                        <?php
                                            }else{
                                                ?>
                                                <div class="form-footer text-right">
                                                    <h6>Scheduling requires at least one report</h6>
                                                    <button disabled="true" type="submit" name="schedule-request" class="btn btn-rose btn-fill">Request</button>
