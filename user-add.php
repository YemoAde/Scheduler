                                ...
                                <form id="RegisterValidation" action="" method="POST" >
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="fullname" type="text" required="true" />
                                        </div>
                                        <div class="form-group label-floating">
                                            <label class="control-label">
                                                Department
                                            ...
                                            <input class="form-control" name="department" type="text" required="true" />
                                        </div>
                                        <div class="form-group label-floating">
                                            <label class="control-label">
                                                Office ID #
                                            ...
                                            <input class="form-control" name="officeID" type="text" required="true" />
                                        </div>
                                        <div class="form-group label-floating">
                                            <label class="control-label">
                                                Group Name
                                            ...
                                            <select class="selectpicker" data-style="btn btn-default" data-size="7" name="group_id">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="selectpicker" data-style="btn btn-default" title="Single Select" data-size="7" name="role">
                                                <option disabled >Select Role/Access</option>
                                        ...
                                        <div class="form-footer text-right">
                                            <button type="submit" name="user-add" class="btn btn-rose btn-fill">Add User</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
