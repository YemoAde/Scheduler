<?php
    ...
    $employees = $employee->all_employee();
?>
<!doctype html>
<html lang="en">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            foreach ($employees as $row) {
                                               echo '<tr>
                                                    <td class="text-center">'.$row['officeID'].'</td>
                                                    <td>'.$row['fullname'].'</td>
                                                    <td>'.$row['department'].'</td>
                                                    <td>'.$row['group_id'].'</td>
                                                    <td>'.$row['role'].'</td>
                                                    <td class="td-actions text-right">
                                                        <a href="user-update.php?id='.$row['_id'].'" type="button" rel="tooltip" class="btn btn-success">
                                                            <i class="material-icons">edit</i>
                                                        </a>
                                                        <a href="delete-employee.php?id='.$row['_id'].'" type="button" rel="tooltip" class="btn btn-danger">
